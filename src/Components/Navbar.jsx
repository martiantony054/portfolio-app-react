...
function NavbarDef() {
  ...
  return (
    <div>
    <Navbar className="w-full px-1 py-2 lg:px-8 lg:py-4 text-black bg-black border-transparent">
  <div className="container mx-auto flex items-center justify-between  w-full">
    <div className="flex items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 mr-2 text-white"> 
        <path fillRule="evenodd" d="M18.685 19.097A9.723 9.723 0 0 0 21.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 0 0 3.065 7.097A9.716 9.716 0 0 0 12 21.75a9.716 9.716 0 0 0 6.685-2.653Zm-12.54-1.285A7.486 7.486 0 0 1 12 15a7.486 7.486 0 0 1 5.855 2.812A8.224 8.224 0 0 1 12 20.25a8.224 8.224 0 0 1-5.855-2.438ZM15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" clipRule="evenodd" />
      </svg>
      <Typography as="a" href="#" className="cursor-pointer py-1 font-medium text-3xl text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-white">
        MARTIN ANTONY
      </Typography>
    </div>
    ...
    <IconButton
      variant="text"
      className="ml-auto h-6 w-6 text-inherit hover:bg-transparent focus:bg-transparent  lg:hidden  text-white "
      ripple={false}
